          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {onSignOut && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-700 text-xs font-bold transition active:scale-95 shadow-sm"
              >
